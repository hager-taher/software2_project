...
const createUser = async (req, res) => {
    try {
        ...
        const { username, email, password,confirmPassword, firstName, lastName, mobileNumber, gender, isAdmin } = req.body;

        // Check if all required fields are provided
        if (!username || !email || !password || !firstName || !lastName || !mobileNumber || !gender || isAdmin === undefined || !confirmPassword) {
